...
There's a guide for this example at [nsv.wakeuplabs.link](https://nsv.wakeuplabs.link/docs/guides/building-a-battleship-game). Check it out to know more about the project.
