...
> Notice the generated verifier encodes your vk in a call to a global verifier. The cli already provides some default addresses for these but feel free to do your own deployment following [the repo instructions](https://github.com/wakeuplabs-io/noir-stylus-verifier) and specify that while deploying.

4) Check Stylus compatibility and estimated cost of the generated verifier.
...
Check `nsv verify --help` for more options.
...
- Tutorials: [Voting App](/docs/tutorials/building-a-voting-app), [Battleship Game](/docs/tutorials/building-a-zk-battleship-game)
