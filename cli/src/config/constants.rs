...
pub(crate) const BB_REQUIREMENT: Requirement = Requirement {
    program: "bb",
    version_arg: "--version",
    required_version: Some("0.86.0"),
    required_comparator: Comparison::Equal,
    required_hash: Some("f09a13bfba9797d9569da5a45380354176bdf4ada6409f710640a21ddd06ba40"),
};

pub(crate) const NARGO_REQUIREMENT: Requirement = Requirement {
    program: "nargo",
    version_arg: "--version",
    required_version: Some("1.0.0-beta.6"),
    required_comparator: Comparison::Equal,
    required_hash: None,
};
